...
- Frontend Flutter: bootstrap local activo en `frontend/` con estructura por capas (`pages/services/widgets`), flujo `health/profile/sync/list/warmup/score` y persistencia local de URL/token/tender_id.
