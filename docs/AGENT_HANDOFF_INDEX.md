...
11. `docs/E2E_PREPROD_VALIDATION.md` (guia para validacion con credenciales reales)
12. `docs/nexus-blueprint-agente.md` (vision completa y arquitectura)
13. `rdf.md` (PRD negocio original)
